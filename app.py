...
portfolio_data = {
    "personal_info": {
        ...
        "title": "Aspiring AI/ML & Cloud Engineer",
        "bio": "Passionate AI/ML Developer and Cloud Enthusiast with hands-on experience in AI/ML, Generative AI, Deep Learning, AWS, and Data Structures & Algorithms (DSA). Currently working as an AI & Machine Learning Intern, I’ve contributed to multiple real-world projects spanning intelligent systems and scalable cloud-based solutions. Proficient in Python and Java, with a strong foundation in writing optimized, efficient code.",
        "contact": {
            "phone": "+91 6305509208",
   ...
   },
   {
       ...
       "skills": ["Flask", "Django", "AWS", "GitHub"]
   },
   {
       "category": "Data Structures & Algorithms",
       "skills": ["Arrays", "Linked Lists", "Trees", "Graphs", "Dynamic Programming", "Searching & Sorting"]
   },
   {
       "category": "Data Tools",
    ...
    "experience": [
        {
            ...
            "description": "Currently working as an AI/ML intern at The SmartBridge, contributing to end-to-end development of machine learning models for real-world use cases. Responsibilities include data preprocessing, model training, evaluation, and cloud deployment using Python, Scikit-learn, TensorFlow, and AWS. Also involved in projects related to NLP, computer vision, and intelligent automation."
        }
    ],
    "projects": [
        {
